FROM jcrugzz/alpine-kubernetes:3.3
...
ENV VERSION=v10.15.3  NPM_VERSION=6
...
RUN apk add --no-cache curl make gcc g++ tar xz python linux-headers binutils-gold gnupg libstdc++ && \
